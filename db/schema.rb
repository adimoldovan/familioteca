...
ActiveRecord::Schema[8.1].define(version: 2026_05_29_160000) do
  ...
  create_table "book_categories", force: :cascade do |t|
    ...
    t.index ["book_id", "category"], name: "index_book_categories_on_book_id_and_category", unique: true
  ...
  create_table "members", force: :cascade do |t|
    ...
    t.boolean "kindle_sender_approved", default: false, null: false
    t.string "name", null: false
    t.string "password_digest", null: false
    t.integer "reading_speed_wpm", default: 200, null: false
    t.datetime "updated_at", null: false
